...
/// StartFarming instruction data
#[cfg_attr(feature = "fuzz", derive(Arbitrary))]
#[repr(C)]
#[derive(Clone, Debug, PartialEq)]
pub struct StartFarming {
    /// Amount of pool token to deposit
    pub pool_token_amount: u64,
}


/// InitializeFarming instruction data
#[cfg_attr(feature = "fuzz", derive(Arbitrary))]
#[repr(C)]
#[derive(Clone, Debug, PartialEq)]
pub struct InitializeFarming {
    /// Amount of farming token to deposit
    pub token_amount: u64,
    /// Amount of farming tokens unlocked each period_length
    pub tokens_per_period: u64,
    /// Amount pf time between farming token unlocks in seconds
...
impl SwapInstruction {
    ...
    pub fn unpack(input: &[u8]) -> Result<Self, ProgramError> {
        ...
        Ok(match tag {
            ...
            9 => {
                let (token_amount, rest) = Self::unpack_u64(rest)?;
                let (tokens_per_period, rest) = Self::unpack_u64(rest)?;
                let (period_length, _rest) = Self::unpack_u64(rest)?;

                Self::InitializeFarming(InitializeFarming {
                    token_amount,
                    tokens_per_period,
                    period_length,
                })
    ...
    pub fn pack(&self) -> Vec<u8> {
        ...
        match &*self {
            ...
            Self::InitializeFarming(
                ...
                buf.extend_from_slice(&tokens_per_period.to_le_bytes());
                buf.extend_from_slice(&period_length.to_le_bytes());
            }
            Self::TakeFarmingSnapshot => {
                buf.push(10);
            }
...
pub fn initialize(
    ...
    farming_state: &Pubkey,
    token_freeze_pubkey: &Pubkey,
    ...
    let accounts = vec![
        ...
        AccountMeta::new_readonly(*farming_state, false),
        AccountMeta::new_readonly(*token_freeze_pubkey, false),
    ];
...
/// Creates a 'start_farming' instruction.
pub fn start_farming(
    program_id: &Pubkey,
    swap_pubkey: &Pubkey,
    farming_state_pubkey: &Pubkey,
    farming_ticket_pubkey: &Pubkey,
    farming_token_freeze_pubkey: &Pubkey,
    user_token_pubkey: &Pubkey,
    user_transfer_authority: &Pubkey,
    user_key: &Pubkey,
    token_program_id: &Pubkey,
    clock: &Pubkey,
    instruction: StartFarming,
) -> Result<Instruction, ProgramError> {
    let data = SwapInstruction::StartFarming(instruction).pack();

    let accounts = vec![
        AccountMeta::new_readonly(*swap_pubkey, false),
        AccountMeta::new(*farming_state_pubkey, false),
        AccountMeta::new(*farming_ticket_pubkey, false),
        AccountMeta::new(*farming_token_freeze_pubkey, false),
...
/// Creates a 'withdraw_farmed' instruction.
pub fn withdraw_farmed(
    ...
    farming_state_pubkey: &Pubkey,
    farming_ticket_pubkey: &Pubkey,
    farming_token_pubkey: &Pubkey,
    swap_authority_pubkey: &Pubkey,
    user_token_pubkey: &Pubkey,
    user_transfer_authority_pubkey: &Pubkey,
    clock: &Pubkey,
) -> Result<Instruction, ProgramError> {
    let data = SwapInstruction::WithdrawFarmed.pack();

    let accounts = vec![
        AccountMeta::new_readonly(*swap_pubkey, false),
        AccountMeta::new_readonly(*farming_state_pubkey, false),
        AccountMeta::new(*farming_ticket_pubkey, false),
...
/// Creates a 'end_farming' instruction.
pub fn end_farming(
    program_id: &Pubkey,
    token_program_id: &Pubkey,
    swap_pubkey: &Pubkey,
    ...
    farming_token_freeze_pubkey: &Pubkey,
    swap_authority_pubkey: &Pubkey,
    user_pool_token_pubkey: &Pubkey,
    user_transfer_authority_pubkey: &Pubkey,
    clock: &Pubkey,
) -> Result<Instruction, ProgramError> {
    let data = SwapInstruction::EndFarming.pack();
    ...
    let accounts = vec![
        ...
        AccountMeta::new(*farming_token_freeze_pubkey, false),
        AccountMeta::new_readonly(*swap_authority_pubkey, false),
        AccountMeta::new(*user_pool_token_pubkey, false),
        AccountMeta::new_readonly(*user_transfer_authority_pubkey, true),
        AccountMeta::new_readonly(*clock, false),
        AccountMeta::new_readonly(*token_program_id, false),
    ];
...
/// Creates a 'initialize_farming' instruction.
pub fn initialize_farming(
    ...
    let data = SwapInstruction::InitializeFarming(instruction).pack();
